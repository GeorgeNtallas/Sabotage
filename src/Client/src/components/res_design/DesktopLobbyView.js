...
function DesktopLobbyView({
  ...
  return (
    <div
      className="relative flex h-screen bg-cover bg-center overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-3 w-full h-full overflow-hidden">
        {/* Column 1 - Chat */}
        ...
        {/* Column 2 - Main Card */}
        <div className="flex items-center justify-center p-4">
          <div className="bg-black/95 backdrop-blur-lg border-2 border-purple-600/50 rounded-xl shadow-[0_0_30px_rgba(150,50,150,0.3)] p-4 w-[90%] max-w-sm text-white">
            {/* Corner decorations */}
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <div
                          className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 ${
                            isLeader
                              ? "bg-amber-600/50 border-2 border-amber-500 text-amber-300"
                              : "bg-purple-900/50 border-2 border-purple-600 text-purple-300"
                          }`}
                        >
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  onMouseUp={() => setPressedButton(null)}
                  onMouseLeave={() => setPressedButton(null)}
                  className={`flex-1 py-3 bg-gradient-to-r from-red-900 via-red-800 to-amber-900 hover:from-red-800 hover:via-red-700 hover:to-amber-800 border border-red-700/50 text-red-200 rounded-sm font-bold transition relative overflow-hidden group ${
              ...
              {/* Start Game and Settings row (Leader only) */}
              {isCurrentLeader && (
                <div className="flex gap-3">
                  <button
                    ...
                    onMouseUp={() => setPressedButton(null)}
                    onMouseLeave={() => setPressedButton(null)}
                    className={`flex-1 py-3 bg-gradient-to-r from-stone-800 via-stone-900 to-stone-800 hover:from-stone-700 hover:via-stone-800 hover:to-stone-700 border border-stone-600/50 text-stone-300 rounded-sm font-bold transition relative overflow-hidden group ${
