    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-3 gap-4 px-4 overflow-y-auto">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-4 w-full">
              <button
                ...
                className={`px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-md font-bold ${pressedButton === "exit" ? "scale-95 brightness-75" : ""}`}
              >
                {t("game.exit")}
              </button>

              <div className="bg-black/90 rounded-lg p-3 text-center flex-1 border-2 border-purple-500/50 shadow-[0_0_30px_rgba(150,50,150,0.4)]">
            ...
            <div className="bg-black/90 rounded-lg p-2 text-center border-2 border-purple-500/50 shadow-[0_0_30px_rgba(150,50,150,0.4)]">
          ...
          >
            {/* Row 1: Player List */}
            <div className="bg-black/90 rounded-lg p-3 w-full border-2 border-purple-500/50 shadow-[0_0_30px_rgba(150,50,150,0.4)]">
              <div
                className="grid grid-cols-3 text-purple-200 font-bold mb-3 border-b border-purple-500/30 pb-2 text-md"
              ...
              <div
                className="grid grid-cols-3 gap-y-2 text-sm text-purple-200/70"
                style={{ gridTemplateColumns: "2fr 2fr 1fr" }}
              >
                {players.map((player) => (
            ...
            <div className="bg-black/90 rounded-lg p-3 border-2 border-purple-500/50 shadow-[0_0_30px_rgba(150,50,150,0.4)]">
              <h4 className="text-md font-semibold text-purple-300 mb-3 text-center ">
                Quest Team
              </h4>
              <div className="grid grid-cols-2 gap-4 text-sm text-purple-200/70 text-center">
                <div>
        ...
        <div className="flex justify-center items-center gap-4 py-4 px-4 mb-12">
          {showPlayersVote && (
            <button
              ...
              onMouseLeave={() => setPressedButton(null)}
              disabled={hasVoted}
              className={`px-6 py-3 rounded-lg text-white ${hasVoted ? "bg-gray-600 cursor-not-allowed" : `bg-amber-800 hover:bg-amber-900 ${pressedButton === "vote" ? "scale-95 brightness-75" : ""}`}`}
            >
              {hasVoted
          ...
          {showQuestVoteButton && (
            <button
              ...
              onMouseUp={() => setPressedButton(null)}
              onMouseLeave={() => setPressedButton(null)}
              className={`px-6 py-3 bg-amber-800 hover:bg-amber-900 text-white rounded-lg ${pressedButton === "proceed" ? "scale-95 brightness-75" : ""}`}
            >
          ...
          {isLeader && showLeaderVoteButton && (
            <button
              ...
              onMouseUp={() => setPressedButton(null)}
              onMouseLeave={() => setPressedButton(null)}
              className={`px-6 py-3 bg-amber-800 hover:bg-amber-900 text-white rounded-lg ${pressedButton === "leader" ? "scale-95 brightness-75" : ""}`}
            >
              {t("game.leaderVote")}
            </button>
          )}
