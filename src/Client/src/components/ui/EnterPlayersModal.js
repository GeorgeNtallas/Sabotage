...
const EnterPlayersModal = ({ isOpen, onClose, players, setPlayers }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center">
      <div className="bg-black border-2 border-cyan-500/50 rounded-lg shadow-[0_0_30px_rgba(6,182,212,0.4)] w-[90%] h-[90%] max-w-2xl relative flex flex-col text-white">
        ...
        <div className="pt-8 pb-4 px-6 border-b border-cyan-500/30">
          <h1
            className="text-3xl font-bold mb-2 text-center text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400"
            style={{ fontFamily: "MedievalSharp" }}
          >
            ⚔️ {t("oneDevice.knightsRoster")} ⚔️
          </h1>
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto space-y-3 p-6">
          {players.map((player, index) => (
            <div
              key={index}
              className="flex items-center gap-3 bg-zinc-900/50 border border-cyan-500/30 p-3 rounded-lg hover:border-cyan-500/50 hover:shadow-[0_0_10px_rgba(6,182,212,0.3)] transition"
            >
              ...
              <input
                ...
                className="flex-1 bg-transparent border-none text-cyan-100 text-lg focus:outline-none"
                style={{ fontFamily: "MedievalSharp" }}
              />
              <button
        ...
        <div className="flex items-center gap-3 p-6 border-t border-cyan-500/30">
          <input
            ...
            className="flex-1 p-3 rounded-lg bg-zinc-900/50 border border-cyan-500/30 text-cyan-100 focus:outline-none focus:border-cyan-500/50 focus:shadow-[0_0_10px_rgba(6,182,212,0.3)]"
            style={{ fontFamily: "MedievalSharp" }}
          />
          <button
