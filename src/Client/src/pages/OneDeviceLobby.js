...
function OneDeviceLobby() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-black/95 backdrop-blur-lg border-2 border-purple-600/50 rounded-xl shadow-[0_0_30px_rgba(150,50,150,0.3)] p-4 sm:p-6 md:p-8 w-[95%] sm:w-[90%] max-w-sm min-w-[280px] text-white">
        ...
        <div className="flex justify-center mb-4 relative">
          ...
          <img
            ...
            alt="Logo"
            className="w-[70%] sm:w-[60%] max-w-[160px] sm:max-w-[200px] drop-shadow-lg relative z-10"
        ...
        <h2
          className="text-lg sm:text-xl text-center mb-2 text-purple-400"
        ...
        <div
          className="text-xl sm:text-2xl font-bold text-center mb-4 text-purple-300"
          style={{ fontFamily: "MedievalSharp" }}
        >
          {name}
        </div>

        <div className="text-center bg-black/60 border border-purple-500/30 rounded py-2 sm:py-3 mb-3 sm:mb-4">
          <div
          ...
          <div
            className="text-base sm:text-lg font-bold text-purple-400 mt-1"
            style={{ fontFamily: "MedievalSharp" }}
          >
            {newRoomName}
          </div>
        ...
        <div className="bg-black/60 border border-purple-500/30 rounded-lg p-2 mb-3">
          ...
          <div
            className={`${(players?.length || 0) >= 5 ? "grid grid-cols-2 gap-1.5" : "space-y-1.5"} max-h-[100px] sm:max-h-[120px] overflow-y-auto pr-1`}
          >
        ...
        <div className="space-y-2 sm:space-y-3">
          {!(isLeader && players?.includes(playerSessionKey)) && (
            <button
              ...
              className={`w-full py-2.5 sm:py-3 md:py-4 bg-gradient-to-r from-purple-900 via-purple-800 to-violet-900 hover:from-purple-800 hover:via-purple-700 hover:to-violet-800 rounded-sm border border-purple-600/50 font-bold text-sm sm:text-base shadow-[0_4px_15px_rgba(150,50,150,0.4)] transition-all relative overflow-hidden group ${
            ...
            >
              ...
              <span className="bg-purple-500 text-black px-2 py-0.5 rounded-full text-xs ml-1 sm:ml-2 font-bold">
                {players?.length || 0}
              </span>
            </button>
          )}
          ...
          {isLeader && (
            <button
              ...
              onTouchEnd={() => setPressedButton(null)}
              className={`w-full py-2.5 sm:py-3 md:py-4 bg-gradient-to-r from-stone-800 via-stone-900 to-stone-800 hover:from-stone-700 hover:via-stone-800 hover:to-stone-700 rounded-sm border border-stone-600/50 font-bold text-sm sm:text-base transition-all relative overflow-hidden group ${
          ...
          {isLeader && (
            <button
              ...
              onMouseUp={() => setPressedButton(null)}
              onMouseLeave={() => setPressedButton(null)}
              className={`w-full py-2.5 sm:py-3 md:py-4 rounded-sm border font-bold text-sm sm:text-base shadow-lg transition-all relative overflow-hidden group ${
                canStart
          ...
          <button
            ...
            onTouchEnd={() => setPressedButton(null)}
            className={`w-full py-2.5 sm:py-3 md:py-4 bg-gradient-to-r from-red-900 via-red-800 to-amber-900 hover:from-red-800 hover:via-red-700 hover:to-amber-800 rounded-sm border border-red-700/50 font-bold text-sm sm:text-base shadow-[0_4px_15px_rgba(150,50,50,0.4)] transition-all relative overflow-hidden group ${
